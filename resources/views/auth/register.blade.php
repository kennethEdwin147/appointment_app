                ...
                <div class="bg-white rounded-5 overflow-hidden">
                    <div class="row">
                        <div class="col-12 col-lg-6 p-0 h-75">
                            <div class="d-flex justify-content-center h-100 p-12 rounded-4 bg-dark-light">
                                <div class="mw-sm py-12 px-10 bg-white rounded-4">
                                    ...
                                    <p class="fw-medium text-muted mb-6">Rejoignez notre communauté !</p>
                        ...
                        <div class="col-12 col-lg-6 pt-16 px-8 px-sm-16 pb-20">
                            <div>
                                <span class="d-block fs-6 fw-semibold mb-4">Créer un compte</span>
                                <h3 class="fs-1 mb-6">Rejoignez-nous dès aujourd'hui !</h3>
                                <p class="lead fs-8 mb-16">
                                    Inscrivez-vous pour réserver des sessions avec vos créateurs préférés.
                                    <br>
                                </p>
                                <form method="POST" action="{{ route('register.user') }}">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input id="firstname" type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" value="{{ old('first_name') }}" placeholder="ex. Jean" required autocomplete="first_name" autofocus>
                                        @error('first_name')
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input id="lastname" type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" value="{{ old('last_name') }}" placeholder="ex. Dupont" required autocomplete="last_name">
                                        @error('last_name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="ex. jean.dupont@email.com" required autocomplete="email">
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <button class="btn btn-lg py-4 mb-6 btn-primary w-100" type="submit">{{ __('S\'inscrire') }}</button>
                                    <p class="d-flex align-items-center text-muted fs-9 fw-medium mb-0">
                                        <span class="me-1">Vous avez déjà un compte ?</span>
                                        <a class="btn text-muted border-0 p-0" href="{{ route('login') }}">{{ __('Connectez-vous') }}</a>
                                    </p>
