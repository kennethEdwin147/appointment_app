...
<body>
<div class="container">
    <h3>Modifier le type d'événement</h3>
    ...
    <form method="POST" action="{{ route('event_type.update', $eventType) }}">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" value="{{ old('name', $eventType->name) }}" required>
            @error('name')
        ...
        <div class="form-group">
            ...
            <textarea name="description" id="description" rows="3">{{ old('description', $eventType->description) }}</textarea>
            @error('description')
                <div class="error">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" name="default_duration" id="default_duration" value="{{ old('default_duration', $eventType->default_duration) }}" min="1" max="1440" required>
        ...
        <div class="form-group">
            ...
            <input type="number" step="0.01" name="default_price" id="default_price" value="{{ old('default_price', $eventType->default_price) }}" min="0">
            @error('default_price')
                <div class="error">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" name="default_max_participants" id="default_max_participants" value="{{ old('default_max_participants', $eventType->default_max_participants) }}" min="1">
        ...
        <div class="form-group {{ old('meeting_platform', $eventType->meeting_platform) == 'custom' ? '' : 'hidden' }}" id="meeting_link_container">
            <label for="meeting_link">Lien de réunion personnalisé</label>
            <input type="url" id="meeting_link" name="meeting_link" value="{{ old('meeting_link', $eventType->meeting_link) }}" placeholder="https://exemple.com/reunion">
            @error('meeting_link')
                <div class="error">{{ $message }}</div>
            @enderror
